...
async function gitCommitAndPush() {
  try {
    ...
    console.log('Committing changes with message "build a project"...');
    const { stdout: commitStdout, stderr: commitStderr } = await execAsync('git commit -m "build a project" --allow-empty');
